...
type
 ...
 INSTR_FUNCTION, INSTR_RETURN,INSTR_GLOBAL,INSTR_REFERENCE,INSTR_GOTO,INSTR_LABEL,
 INSTR_BREAK,INSTR_NEXT,INSTR_STEP);
...
begin
 ...
 else if l='label' then add(tpos,INSTR_LABEL,l)
 else if l='goto' then add(tpos,INSTR_GOTO,l)
 else if l='break' then add(tpos,INSTR_BREAK,l)
 else if l='next' then add(tpos,INSTR_NEXT,l)
 else if l='step' then add(tpos,INSTR_STEP,l)
