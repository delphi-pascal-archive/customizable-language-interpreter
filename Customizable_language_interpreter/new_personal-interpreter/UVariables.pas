...
function TVariablesStack.GetString:string;
var
 i:integer;
begin
 result:='';
 if Fcount=0 then exit;
 for i:=0 to FStack[Fcount-1].FCount-1 do
  result:=result+FStack[Fcount-1].GetNames(i)+':'+FStack[Fcount-1].FValues[i].StringValue+#13#10;
end;
